...
extern void *mono_aot_module_Xamarin_LockScreen_info;
...
void monotouch_register_modules ()
{
	...
	mono_aot_register_module (mono_aot_module_Xamarin_LockScreen_info);
...
void monotouch_register_assemblies ()
{
	...
	monotouch_open_and_register ("Xamarin.LockScreen.dll");
...
{
	@autoreleasepool { return monotouch_main (argc, argv, false); }
}
